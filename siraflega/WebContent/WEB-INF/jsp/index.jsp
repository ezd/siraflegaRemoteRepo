...
.mainTitle {
	...
	background-color: rgba(0, 191, 195, 0.87);
}
		...
		<div class="row pageBody">
			<ul>
				...
				<c:forEach items="${postedJobs}" var="postedJob">
					...
					<li><div class="col-sm-12 col-md-6 jobdisplayholder" >
							<div class="col-sm-12" id="jobdisplayarea">
								<div class="mainTitle">
									<a
								...
								<div class="subTitle">
									<p>
										For <a
											href="${pageContext.request.contextPath}/company/${postedJob.company.id}.html">${postedJob.company.name}</a>
										from
