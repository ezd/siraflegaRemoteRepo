	...
	<div class="modal-dialog overflowstyle" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="updateWrokExp"
					data-dismiss="modal" data-backdrop="false">Save changes</button>
				<button type="button" class="btn btn-primary" id="saveWrokExp"
...
<script type="text/javascript">
	...
	function addExData(data) {
		...
		var listToAdd = '<li>'
				...
				+ 'data-toggle="modal" data-target="#editWorkExpModal" data-id="'
				+ data.id
				+ '" '
