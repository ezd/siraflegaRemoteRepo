...
<div class="modal fade" id="jobModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		...
		<form:form class="form-horizontal" commandName="job" action="${pageContext.request.contextPath}/postJob"  method="post">
			...
			<input type="hidden" class="prevCompanyId"> 
					<div class="form-group">
						...
						<div class="col-sm-10">
							<form:select path="company" id="editCompany" class="form-control selectpicker">
